...
The rest of this section is organised according to the artifacts generated, under the usual division of Preprocessing, Concepts, Taxonomic relations and Non-taxonomic relations.
...
Their use is described for each relevant method.
Terms are described under the Concepts section.
Subconcept relations are described under the Taxonomic relations section.
Labeled relations are described under the Non-taxonomic relations section.
...
\subsubsection{Part of speech and Morphology}
...
\subsection{Non-taxonomic Relations}

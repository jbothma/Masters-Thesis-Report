...
In addition to the framework described in~\citep{Cimiano2009OL}, a way of describing the inputs and outputs of each processing method is needed, which would formalise depencies like those shown in figure~\ref{fig:method-artifact} such that a computer can construct such a graph automatically.

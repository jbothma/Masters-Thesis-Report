...
Most of the concept candidates extracted do appear to be useful labels for classes, but most of them are more general than the domain at hand.
...
Names can be identified using Named Entity Recognition and considering whether words start with upper case, and excluded or replaced by a label for the concept of which the name denotes an instance.
...
An example of how the C-value ranking is working well is with the term "typ 2-diabetes". Both the full term and "2-diabetes" were selected as concepts, but the ranking for "typ 2-diabetes" is very high, while the ranking for "2-diabetes" is very low, since it occurs frequently, but only as part of the complete term.
...
A set of domain-independent stop words can be used to exclude candidates which really indicate the degree of some concept, such as olika, många, två, tre, stor, liten.

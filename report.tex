...
The results in Section~\ref{sec:results:eval} indicate several things about the performance of the prototype on candidate extraction and recommendation.
...
\subsection{Candidate extraction and recommendation}

...
The analysis in Chapter~\ref{chapter:analysis} showed that a tool was produced that could successfully extract and recommend candidates for ontology elements.
These candidates could then be selected for constructing a domain ontology using the tool.
...
Further work can significantly improve these results.

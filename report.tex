...
The ontology element extraction methods used need 
...
The JAPE code before the --> works like a regular expression on annotations.
...
Each time this regular expression matches, the part after the --> adds new annotations.

...
The importance of the extracted relations is then determined using approaches based on statistical analysis, machine learning or graph theory, for example.
...
Common approaches for extracting non-taxonomic relations include association rule mining, lexico-syntactic patterns, and statistical approaches for selecting and generalising verb frames - subject-predicate-object triples where the verb is the main verb of a sentence and the subject and object are terms in the domain.
...
The term candidate selection was performed as annotations in the corpus along with syntactic feature annotation for convenience.
...
The JAPE expression defining the filter is shown in \todo{embed and describe the JAPE code}

...
Preprocessing is done partly using the Korp corpus import pipeline~(\ref{sec:background:korp}, and partly using GATE~(\ref{sec:background:gate}).
...
I created a graphical user interface as part of the Preprocessing compoto select the project directory and corpus files, and trigger the import.
...
Term candidates are extracted using the C-value part from the C-value NC-value method for extracting multi-word terms~(\ref{sec:background:cval}.
...
I to demonstrate the approach based on example patterns in~\cite{Zouaq11OntoCmaps}.
...
This section shows how to install and use the prototype while demonstrating it with a sample of the evaluation corpus.
...
\subsection{Usage}
\begin{figure}
  \includegraphics[width=10cm]{graphics/1._Open_Protege.png}
  \caption{Open Protege}
  \label{fig:walkthrough1}
\end{figure}
\begin{figure}
  \includegraphics[width=10cm]{graphics/2._Show_OL_plugin_tab.png}
  \caption{Show OL plugin tab}
  \label{fig:walkthrough2}
\end{figure}
\begin{figure}
  \includegraphics[width=10cm]{graphics/3._Select_OL_Tab.png}
  \caption{Select OL Tab}
  \label{fig:walkthrough3}
\end{figure}
\begin{figure}
  \includegraphics[width=10cm]{graphics/4._Select_new_OL_project_directory.png}
  \caption{Select new OL project directory}
  \label{fig:walkthrough4}
\end{figure}
\begin{figure}
  \includegraphics[width=10cm]{graphics/5._Select_directory_containing_corpus_input.png}
  \caption{Select directory containing corpus input}
  \label{fig:walkthrough5}
\end{figure}
\begin{figure}
  \includegraphics[width=10cm]{graphics/6._Filter_corpus_by_suffix.png}
  \caption{Filter corpus by suffix}
  \label{fig:walkthrough6}
\end{figure}
\begin{figure}
  \includegraphics[width=10cm]{graphics/7._Buttons_disabled_while_working.png}
  \caption{Buttons disabled while working}
  \label{fig:walkthrough7}
\end{figure}
\begin{figure}
  \includegraphics[width=10cm]{graphics/8._Extracted_terms_and_relations_shown_when_finished.png}
  \caption{Extracted terms and relations shown when finished}
  \label{fig:walkthrough8}
\end{figure}
\begin{figure}
  \includegraphics[width=10cm]{graphics/9._Non-taxonomic_relations_tab.png}

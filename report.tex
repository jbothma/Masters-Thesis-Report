...
\begin{itemize}
  ...
  \item \emph{adj of qty/qlty} The candidate is an adjective of quantity or quality
  \item \emph{incomplete term} An incomplete of a term meaning nothing iby itself
  \item \emph{insufficient lexical analysis} <-- not a fault term
  \item \emph{lexical filter} <-- could put this with not a term
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{concepts-mistakes}
...
\begin{itemize}
  ...
  \item \emph{head not a term} <-- merge with ``not a term''
  \item \emph{negation} <-- merge with degree
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{subconcepts-mistakes}
...
\emph{yes too general} means that the relation isn't wrong but the terms are not precise enough for the relation to be useful.

\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{labeled-relations}
...
\subsection{Comparison with manually-extracted candidates}

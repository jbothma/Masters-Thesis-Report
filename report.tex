...
The results in Section~\ref{sec:results:eval:cands} indicate several things about the performance of the prototype on candidate extraction and recommendation.
Most of the candidates extracted do appear to be useful labels for classes, but most of them are more general than the domain at hand.
...
The expectations still feel a bit unclear, even though I'm more familiar with the process. It's difficult to bring together the ideas of "master's level doesn't need original reseach", "
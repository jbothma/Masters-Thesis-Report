...
Language detection would allow application of langage-specific tools to sections of text in other language, removing another common source of error (See \ref{sec:results:eval:cands}, \ref{chap:eval-corp-links}pts}).
...
In addition to the framework described in~\citep{Cimiano2009OL}, a way of describing the inputs and outputs of each processing method is needed, similarly to that shown in figure~\label{fig:method-artifact}.

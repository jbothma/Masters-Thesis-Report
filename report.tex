...
However, the issues that this thesis attempts to address are made explicit at the end of this section\todo{better to refer to a section number}.
...
Text2Onto allows algorithm components to register their interest different kinds of changes, and publish such changes to other interested components\cite{Cimiano2005Text2Onto}.
A formal provenance model approach\citep{Groth09PipeProv}, tracking all data, methods and decisions involved in changes, might be an appropriate way of answering many questions of the researcher and the organisation.
...
However, one might question the authority of information gathered from the internet, especially from the increasing trend of using socially generated data \cite{Wong11Survey}.

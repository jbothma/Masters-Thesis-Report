...
The availability of models with different tags gives flexibility and means I did not need to generate models before commencing development.
...
I could not get the tagger used in the Granska\todo{ref} project working within a short amount of time so I abandonded it.
...
For use in this form, I used the swedish model provided by \todo{ref fors model}

\subsection{Lemmatization}



\subsection{Linguistic Filter}
